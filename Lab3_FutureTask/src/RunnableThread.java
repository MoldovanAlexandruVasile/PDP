...
public class RunnableThread implements Callable<String> {
    ...
    RunnableThread(Integer millisec, String name, Matrix matrix1, Matrix matrix2, Matrix matrix3, Integer startLine, Integer fromLineToLine, String operation,
                   Integer col) {
        this.name = name;
